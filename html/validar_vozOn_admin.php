...
if($valor=='luz sala' || $valor=='fuz sala' || $valor=='suz sala')
{
 ...
 echo '<script language="javascript">alert("Se ha encendido la luz de la Sala");</script>'; 
}
...
if($valor=='luz jardín' || $valor=='fuz jardín' || $valor=='suz jardín')
{
 ...
 echo '<script language="javascript">alert("Se ha encendido la luz del Jardin");</script>'; 
}
